...
$botToken = "5958193677:AAFatt05Tg1fCjdtAonYv-gwY0yTqxAOkZg"; // Enter ur bot token
...
elseif($userId == '1991559687') {
$usernam = ''.mtchex.'%0A [Owner]';
}
else {
$usernam = $username;
}
$sk = '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';
